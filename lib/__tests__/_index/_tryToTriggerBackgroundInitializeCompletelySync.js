...
describe('#_tryToTriggerBackgroundInitializeCompletelySync', () => {
  ...
  it('support initOption.autoBackgroundCompletelySync', () => {
    thinker.initOption.autoBackgroundCompletelySync = false
    thinker._tryToTriggerBackgroundInitializeCompletelySync({}, {syncAllData: false})
    expect(thinker._doSync).not.toBeCalled()
  })
})
